...
theme.detectNav = function(){
  var navWidth = $('.nav--desktop .main-menu-1').outerWidth() + $('.nav--desktop .main-menu-2').outerWidth();
...
theme.Product = (function() {
  function Product(container) {
    ...
    this.selectors = {
      ...
      addToCart: '[id="AddToCart-'+sectionId+'"]',
      productPrice: '[id="ProductPrice-'+sectionId+'"]',
      buttonPrice: '[id="ButtonPrice-'+sectionId+'"]',
      comparePrice: '#ComparePrice-'+sectionId,
      comparePriceWrapper: '#ComparePriceWrapper'+sectionId,
      addToCartText: '[id="AddToCartText-'+sectionId+'"]',
...
//         }
        ...
        ajaxAddItem.bind(this)(form_object); //BOLD:PO
      });
      ...
      var ajaxAddItem = function(data) {
        ...
        BOLD.helpers.addItemFromForm(form[0], addSuccess, addError, {endpoint:'/cart/add.js'});
        updateHeaderTotal;
      } else {
    ...
    // Bold:POv2
      ...
      var addSuccess = function(product){
        ...
        productObject = {
          ...
          properties: product.properties_formatted, //Bold PO
...
$(document).ready(function() {
  ...
  $('.homepage-logos').each(function() {
    var $container = $(this);
    $container.find('[data-target]').each(function() {
      var $link = $(this);
      $link.mouseenter(function() {
        $container.find('.message').hide();
        $container.find('.logo-bar__item').removeClass('active');
        $link.parent().addClass('active');
        $container.find($link.data('target')).fadeIn();
      });
    });
  });
  
  $('.sidebar__heading').on('click', function () {
