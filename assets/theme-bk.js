  ...
  $(function() {
    ...
    $('body').on('click', '.cart__checkout', function(e) {
      ...
      if ($discountCode.length) {
        var items = [];
        var i = 1;
        $discountCode.find('select').each(function() {
          var $select = $(this);
          if ($select.val()) {
            items.push({
              quantity: 1,
        ...
        if (items.length > 0) {
          ...
          $.post('/cart/add.js', {
            items: items,
            success: function() {
              window.location.href = '/checkout?discount=' + $discountCode.data('code');
            }
          });          
        }
      }
...
(function($){
  ...
  $(function(){
    ...
    $('.tag-list-filters li').on('click', function (e) {
      e.preventDefault();
      var $this = $(this);
...
//       var highestBox = 0;
//       $('.section-product>.grid').each(function(){  
//         if($(this).height() > highestBox){  
//           highestBox = $(this).height();  
//         }
//       });    
//       $('.section-product').height(highestBox);      
//     }
//     adjustHeight();
//     $(window).on('resize.products', adjustHeight);
  })
